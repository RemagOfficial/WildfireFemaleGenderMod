...
public record SimpleGenderArmor(float physicsResistance, float tightness) implements IGenderArmor {
    ...
    public static final SimpleGenderArmor LEATHER = new SimpleGenderArmor(0, 0.5F);
    public static final SimpleGenderArmor CHAIN_MAIL = new SimpleGenderArmor(0, 0.2F);
